...
async function handleAPI(request, env, path) {
  ...
  if (path === '/api/brain') {
    return json({ ips: [{ip:'104.16.128.50', ms:42},{ip:'104.17.176.20', ms:55},{ip:'104.18.22.100', ms:68},{ip:'104.21.48.10', ms:38},{ip:'cdnjs.cloudflare.com', ms:31}] });
  }
